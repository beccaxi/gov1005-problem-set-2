...
# Remember to install and load ggthemes to use in graphing later
...
```{r fivethirtyeight graph}

# An online introduction to the ggthemes package was helpful in discovering the
# fivethirtyeight theme. I ended up manually labeling the x-axis ticks, though
